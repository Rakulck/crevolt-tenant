...
export const InvestmentAnalysisSchema = z.object({
  executiveSummary: z.string().describe("Brief overview of the investment opportunity"),
  investmentHighlights: z
    .array(z.string())
    .describe("Key selling points and highlights of the investment"),
  units: z.number().optional().describe("Total number of units in the property"),
  beds: z.number().optional().describe("Number of beds (for student housing)"),
  yearBuilt: z.number().optional().describe("Year the property was built (vintage)"),
...
export type InvestmentAnalysisResponse = z.infer<typeof InvestmentAnalysisResponseSchema>;
